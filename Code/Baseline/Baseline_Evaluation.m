...
Table[Block[{models,DADT,GCM,OBSER},
SetDirectory["/g/g92/pan11/Baseline"];
models=Map[Import,FileNames["Baseline_"<>ToString[index]<>"_*mx"]];
Print["Index="<>ToString[index]];
DADT=Block[{ms},
	ms=Map[#[["Generator_GCM->Obser"]]&,models];
	Table[Block[{tempt=ms[[i]]},Print[i];
	If[MemberQ[{0,2,3,4,8,9,10,14},index],
	Map[tempt[#[["P_GCM"]],TargetDevice->"GPU"]&,test],
...
Export["/g/g92/pan11/result_Baseline_"<>ToString[index]<>".mx",Map[NumericArray[#,"Real32"]&,{DADT,GCM,OBSER}]];],{index,0,14}];
