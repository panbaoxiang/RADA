...
ReportCycleGan[net_] :=
  Block[{gen,dGCM,dObser,obserG,obserD,gcmD,meanDiff,varDiff,dlossGCM,dlossObser},
        ...
        If[meanDiff+varDiff<=DiffMean+DiffVar,
          Block[{},
		Print[index];
                Export["/g/g92/pan11/Baseline_0_GAN_"<>index<>".mx",net];
...
NetTrain[gan,
    ...
    TrainingUpdateSchedule -> {"Discriminator_GCM->Obser","Generator_GCM->Obser"},
    LearningRateMultipliers -> {"Scale_GCM->Obser" -> 0, 
                             "Generator_GCM->Obser" -> -1,"Discriminator_GCM->Obser"->1},
    BatchSize -> 32,
    TargetDevice->"GPU",
...
gan=Import["/g/g92/pan11/Baseline_0_GAN_"<>index<>".mx"];
